...
/* Change oembed size */
function youtube_embed_size() {
  return array('width' => 900, 'height' => 595);
}
add_filter( 'embed_defaults', 'youtube_embed_size' );
...
wp_register_script('slick', get_template_directory_uri() . '/js/slick.js', '','1.1', true);
